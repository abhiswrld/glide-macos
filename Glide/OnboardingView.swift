...
struct OnboardingView: View {
    ...
    private func installHelper() {
        ...
        let script = """
        do shell script "launchctl bootout system/com.abhinav.glide-daemon 2>/dev/null || launchctl unload -w /Library/LaunchDaemons/com.abhinav.glide-daemon.plist 2>/dev/null || true; rm -f /Library/PrivilegedHelperTools/glide-daemon 2>/dev/null || true; mkdir -p /Library/PrivilegedHelperTools && cp -f '\(daemonSource)' /Library/PrivilegedHelperTools/glide-daemon && chown root:wheel /Library/PrivilegedHelperTools/glide-daemon && chmod 755 /Library/PrivilegedHelperTools/glide-daemon && cp -f '\(plistSource)' /Library/LaunchDaemons/com.abhinav.glide-daemon.plist && chown root:wheel /Library/LaunchDaemons/com.abhinav.glide-daemon.plist && chmod 644 /Library/LaunchDaemons/com.abhinav.glide-daemon.plist && (launchctl bootstrap system /Library/LaunchDaemons/com.abhinav.glide-daemon.plist 2>/dev/null || launchctl load -w /Library/LaunchDaemons/com.abhinav.glide-daemon.plist) && launchctl kickstart -k system/com.abhinav.glide-daemon" with administrator privileges
        """
